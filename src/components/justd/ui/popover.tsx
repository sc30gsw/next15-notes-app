...
const Content = ({
  ...
  // biome-ignore lint/style/noNonNullAssertion: This is a safe assertion because the Popover component is always used within a PopoverProvider.
    ...
    >
      {showArrow && (
        <OverlayArrow className="group">
          {/* biome-ignore lint/a11y/noSvgWithoutTitle: This is a decorative icon.  */}
          <svg
            width={12}
            height={12}
            viewBox="0 0 12 12"
