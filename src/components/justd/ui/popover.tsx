...
const Content = ({
  ...
  // biome-ignore lint/style/noNonNullAssertion: This is a safe assertion
    ...
    >
      {showArrow && (
        <OverlayArrow className="group">
          {/* biome-ignore lint/a11y/noSvgWithoutTitle: This icons is decorative and does not need a title. */}
          <svg
            width={12}
            height={12}
            viewBox="0 0 12 12"
