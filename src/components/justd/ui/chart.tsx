...
const Style = ({ id, config }: StyleProps) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: This is a justd component
...
>(
  (
    ...
    const tooltipLabel = useMemo(() => {
      if (hideLabel || typeof payload?.length === 'undefined') {
        return null
      }
    ...
    if (!active || typeof payload?.length === 'undefined') {
      return null
    }
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {/* biome-ignore lint/complexity/noExcessiveCognitiveComplexity: This is a justd component */}
